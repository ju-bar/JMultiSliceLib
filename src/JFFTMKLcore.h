//
// C++ header file: JFFTMKLcore.h
// declaration of class CJFFTMKLcore (implementation see JFFTMKLcore.cpp)
//
...
#define JFFTMKLCORE_H
#define JFFTMKLCORE_DIM_MIN		(1)
#endif // JFFTMKLCORE_H
//
class CJFFTMKLcore
{
...
protected:
	...
	DFTI_DESCRIPTOR_HANDLE m_descr; // core plan descriptor
	fcmplx* m_pcw; // core complex working array
public:
